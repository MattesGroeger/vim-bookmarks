describe 'empty model'
  ...
  it 'should deserialize bookmarks'
    ...
    call add(data, "let l:bm_sessions = {'default': {'file1': [{'sign_idx': 99, 'line_nr': 1, 'content': 'foo'},],'file2': [{'sign_idx': 50, 'line_nr': 12, 'content': 'bar'},{'sign_idx': 51, 'line_nr': 15, 'content': '''test'''},],}}")
    ...
    Expect bm#location_list() ==# ["file1:1:foo", "file2:12:bar", "file2:15:'test'"]
    Expect len(result) ==# 3
    Expect result ==# [{"file": "file1", "line_nr": 1, "sign_idx": 99, "content": "foo"},
                      \{"file": "file2", "line_nr": 12, "sign_idx": 50, "content": "bar"},
                      \{"file": "file2", "line_nr": 15, "sign_idx": 51, "content": "'test'"}]
  end
...
describe 'model with multiple bookmarks in different files'
  ...
  it 'should serialize'
    ...
    Expect s["file2"] ==# [{"line_nr": 34, "sign_idx": 2, "content": "file2/line34"}, {"line_nr": 45, "sign_idx": 5, "content": ""}]
